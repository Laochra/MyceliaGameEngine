...
static constexpr inline float sqr(float x) noexcept
{
	return x * x;
}
static constexpr inline float cube(float x) noexcept
{
	return x * x * x;
}
static constexpr inline float quart(float x) noexcept
{
	return x * x * x * x;
}
static constexpr inline float quint(float x) noexcept
{
	return x * x * x * x * x;
}
