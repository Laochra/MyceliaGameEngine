...
enum class InputCode
{
	...
	// Any Gamepad Input
	GamepadA			= 1000 + GLFW_GAMEPAD_BUTTON_A,
	GamepadB			= 1000 + GLFW_GAMEPAD_BUTTON_B,
	GamepadX			= 1000 + GLFW_GAMEPAD_BUTTON_X,
	GamepadY			= 1000 + GLFW_GAMEPAD_BUTTON_Y,
	GamepadLB		= 1000 + GLFW_GAMEPAD_BUTTON_LEFT_BUMPER,
	GamepadRB		= 1000 + GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER,
	GamepadLM		= 1000 + GLFW_GAMEPAD_BUTTON_BACK,
	GamepadRM		= 1000 + GLFW_GAMEPAD_BUTTON_START,
	GamepadGuide	= 1000 + GLFW_GAMEPAD_BUTTON_GUIDE,
	GamepadLS		= 1000 + GLFW_GAMEPAD_BUTTON_LEFT_THUMB,
	GamepadRS		= 1000 + GLFW_GAMEPAD_BUTTON_RIGHT_THUMB,
	GamepadDPUp		= 1000 + GLFW_GAMEPAD_BUTTON_DPAD_UP,
	GamepadDPRight	= 1000 + GLFW_GAMEPAD_BUTTON_DPAD_RIGHT,
	GamepadDPDown	= 1000 + GLFW_GAMEPAD_BUTTON_DPAD_DOWN,
	GamepadDPLeft	= 1000 + GLFW_GAMEPAD_BUTTON_DPAD_LEFT,

	GamepadFirstButton	= GamepadA,
	GamepadLastButton		= GamepadDPLeft,

	GamepadLSX = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_LEFT_X,
	GamepadLSY = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_LEFT_Y,
	GamepadRSX = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_RIGHT_X,
	GamepadRSY = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_RIGHT_Y,
	GamepadLT  = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_LEFT_TRIGGER,
	GamepadRT  = GamepadLastButton + 1 + GLFW_GAMEPAD_AXIS_RIGHT_TRIGGER,

	GamepadFirstAxis	= GamepadLSX,
	GamepadLastAxis	= GamepadRT,

	GamepadUndefined = 1021,
	...
	Gamepad0Guide		= GamepadGuide		+ (100 * 1),
	...
	Gamepad1Guide		= GamepadGuide		+ (100 * 2),
	...
	Gamepad2Guide		= GamepadGuide		+ (100 * 3),
	...
	Gamepad3Guide		= GamepadGuide		+ (100 * 4),
	...
	Gamepad4Guide		= GamepadGuide		+ (100 * 5),
	...
	Gamepad5Guide		= GamepadGuide		+ (100 * 6),
	...
	Gamepad6Guide		= GamepadGuide		+ (100 * 7),
	...
	Gamepad7Guide		= GamepadGuide		+ (100 * 8),
	...
	Gamepad8Guide		= GamepadGuide		+ (100 * 9),
	...
	Gamepad9Guide		= GamepadGuide		+ (100 * 10),
	...
	Gamepad10Guide		= GamepadGuide		+ (100 * 11),
	...
	Gamepad11Guide		= GamepadGuide		+ (100 * 12),
	...
	Gamepad12Guide		= GamepadGuide		+ (100 * 13),
	...
	Gamepad13Guide		= GamepadGuide		+ (100 * 14),
	...
	Gamepad14Guide		= GamepadGuide		+ (100 * 15),
	...
	Gamepad15Guide		= GamepadGuide		+ (100 * 16),
