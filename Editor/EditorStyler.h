...
namespace EditorStyler
{
	...
	inline void DrawColourEdit3(const char* name, GUI::Colour& colour, bool* changeMade, ImGuiColorEditFlags flags);
	inline void DrawColourEdit4(const char* name, GUI::Colour& colour, bool* changeMade, ImGuiColorEditFlags flags);
}
...
void EditorStyler::DrawColourEdit3(const char* name, GUI::Colour& colour, bool* changeMade, ImGuiColorEditFlags flags)
{
	*changeMade = ImGui::ColorEdit3(name, colour, flags) || *changeMade;
}
void EditorStyler::DrawColourEdit4(const char* name, GUI::Colour& colour, bool* changeMade, ImGuiColorEditFlags flags)
{
