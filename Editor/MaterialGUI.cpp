...
namespace MaterialGUI
{
	...
	void MaterialGUI::Load(string filePathStr)
	{
		...
		{
			Debug::LogWarning(LogID::WRN103, current.filePath, " did not specify a Shader Program. Set to \"PBRLit\".", locationinfo);
		...
		{
			Debug::LogWarning(LogID::WRN102, current.filePath, " Shader Program set to \"PBRLit\".", locationinfo);
	...
	void MaterialGUI::LoadShaderProgram(string filePathStr)
	{
		...
		{
			Debug::LogWarning(LogID::WRN102, current.shaderFilePath, " All fields defaulted to \"None\".", locationinfo);
		...
		// Field Loading
		{
			if (shaderProgram.contains("Attributes"))
			{
				...
				for (int i = 0; i < attributes.size(); i++)
				{
					...
					{
						Debug::LogWarning(LogID::WRN103, "Attribute ", i ," in ", current.shaderFilePath, " did not specify an Exposed status.", locationinfo);
						continue;
					}
					...
					{
						Debug::LogWarning(LogID::WRN103, "Attribute ", i ," in ", current.shaderFilePath, " did not specify a name.", locationinfo);
						continue;
					}

					if (!attributes[i].contains("Type"))
					{
						Debug::LogWarning(LogID::WRN103, "Attribute ", i ," in ", current.shaderFilePath, " did not specify a type.", locationinfo);
						continue;
					}
			...
			else { Debug::LogWarning(LogID::WRN103, current.shaderFilePath, " did not contain an Attributes list.", locationinfo); }
			...
			if (shaderProgram.contains("Uniforms"))
			{
				...
				for (int i = 0; i < uniforms.size(); i++)
				{
					...
					{
						Debug::LogWarning(LogID::WRN103, "Uniform ", i ," in ",  current.shaderFilePath, " did not specify an Exposed status.", locationinfo);
						continue;
					}
					...
					{
						Debug::LogWarning(LogID::WRN103, "Uniform ", i ," in ", current.shaderFilePath, " did not specify a name.", locationinfo);
						continue;
					}

					if (!uniforms[i].contains("Type"))
					{
						Debug::LogWarning(LogID::WRN103, "Uniform ", i ," in ", current.shaderFilePath, " did not specify a type.", locationinfo);
						continue;
					}
			...
			else { dirty = true; Debug::LogWarning(LogID::WRN103, current.shaderFilePath, " did not contain a Uniforms list.", locationinfo); }
		}
